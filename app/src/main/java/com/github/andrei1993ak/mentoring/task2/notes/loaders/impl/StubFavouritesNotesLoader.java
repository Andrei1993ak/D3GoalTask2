...
public class StubFavouritesNotesLoader extends AsyncTaskLoader<List<INote>> {

    StubFavouritesNotesLoader(@NonNull final Context context) {
        super(context);
    }
    ...
    public List<INote> loadInBackground() {
        ...
        return Arrays.asList(note1, note3);
    }
}
